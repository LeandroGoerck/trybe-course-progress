...
console.log(`Losango com D=32cm e d= 18cm: ${Exercise.losangle(32, 18)}`);
console.log(`Losango com D=200cm e d= 50cm: ${Exercise.losangle(200, 50)}`);
console.log(`Losango com D=75cm e d= 25cm: ${Exercise.losangle(75, 25)}`);
